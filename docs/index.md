...
<div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
  <a
    ...
    :key="project.url"
    :href="project.url"
    class="group flex flex-col justify-between gap-6 rounded-2xl border border-line bg-surface-2 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-brand-border hover:bg-brand-subtle"
  >
    <span class="block">
