  ...
  <section class="bleed">
    <div class="site-container pt-8 pb-2.5 md:pt-12 md:pb-4">
      <div class="mb-16 text-center">
        <h2
          class="font-display text-3xl font-semibold tracking-tight text-heading sm:text-4xl md:text-5xl"
        >
          What we <span class="aurora-text">care about</span>
        </h2>
        <p class="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-body sm:text-lg">
      ...
      <div class="mx-auto grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div
          v-for="v in values"
          :key="v.title"
          class="group mx-auto aspect-3/2 w-full max-w-72 overflow-hidden rounded-3xl border border-line bg-surface transition-all duration-300 hover:-translate-y-1 hover:border-line-strong"
        >
          <div
