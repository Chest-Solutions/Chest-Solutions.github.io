      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 right-0 top-[calc(100%+0.5rem)] z-40 max-h-72 max-w-xs overflow-y-auto rounded-xl border border-white/10 bg-[#211d19]/95 p-1.5 shadow-[0_16px_40px_rgba(0,0,0,0.4)] backdrop-blur-2xl"
          >
